...
IF ~Global("Px_agenormeet","LOCALS",1) !Global("Px_agenor","GLOBAL",12)~ THEN BEGIN Interplan2 SAY @101
...
IF ~Global("Px_agenormeet","LOCALS",0) Global("Px_agenor","GLOBAL",12)~ THEN BEGIN Interplan3 SAY @101
	IF ~~ THEN REPLY @102 DO ~SetGlobal("Px_agenormeet","LOCALS",1)~ GOTO Choixmagasin2
	IF ~~ THEN REPLY @1010 GOTO FaitQueRegarder
END
IF ~Global("Px_agenormeet","LOCALS",1) Global("Px_agenor","GLOBAL",12)~ THEN BEGIN Interplan4 SAY @101
...
IF ~~ THEN BEGIN Chaudron SAY @104
	...
	IF ~~ THEN DO ~SetGlobal("agenochaud","LOCALS",1)~ REPLY @108 GOTO Choixmagasin2
